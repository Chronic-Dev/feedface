...
#define IOLog ((void (*)(char *fmt, ...)) 0x801a706d)
#define kalloc ((void *(*)(unsigned int)) 0x80019095)
#define lck_rw_lock_exclusive ((void (*)(void *)) 0x80061bc1)
#define lck_rw_done ((void (*)(void *)) 0x80061ec1)

#define memcmp ((int (*)(void*, void*, int)) 0x8005fec5)
#define memcpy ((void (*)(void*, void*, int)) 0x80067139)
